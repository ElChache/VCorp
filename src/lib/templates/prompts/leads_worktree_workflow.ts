...
4. Notify Human Director (via /api/projects/$PROJECT_ID/message-director) and all teams
...
- **Weekly architecture updates** to Human Director (via /api/projects/$PROJECT_ID/message-director)
...
Use /api/projects/$PROJECT_ID/message-director to notify: "Please note this serious workflow violation requiring immediate correction."
